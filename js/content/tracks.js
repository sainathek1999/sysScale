(function () {
  ...
  window.SS.TRACKS = [
    ...
    },
    {
      ...
      icon: '⚙',
      color: '#10B981',
      description: '16 production systems — interactive estimator for each.',
      modules: [
        ...
        { id: 'distributed-cache',  title: 'Distributed Cache',     readingMins: 0, difficulty: 'intermediate', estimatorId: 'distributed-cache'  },
        { id: 'message-queue',      title: 'Message Queue',         readingMins: 0, difficulty: 'intermediate', estimatorId: 'message-queue'      },
        { id: 'web-crawler',        title: 'Web Crawler',           readingMins: 0, difficulty: 'advanced',     estimatorId: 'web-crawler'        },
        { id: 'object-storage',     title: 'Object Storage',        readingMins: 0, difficulty: 'advanced',     estimatorId: 'object-storage'     },
        { id: 'cdn',                title: 'CDN',                   readingMins: 0, difficulty: 'intermediate', estimatorId: 'cdn'                },
        { id: 'payment',            title: 'Payment System',        readingMins: 0, difficulty: 'advanced',     estimatorId: 'payment'            },
        { id: 'social-graph',       title: 'Social Graph',          readingMins: 0, difficulty: 'advanced',     estimatorId: 'social-graph'       },
      ],
    },
    {
      id: 'interview',
